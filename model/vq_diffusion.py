...
parser.add_argument('--save_dir_image', default='./data_gen/vq/image', type=str, help='data_save_path(dir)')
parser.add_argument('--save_dir_txt', default='./data_gen/vq/text', type=str, help='data_save_path(dir)')
